...
<head>
    ...
    <!-- wave CSS
		============================================ -->
    <link rel="stylesheet" href="{{ asset('css/admin/wave/waves.min.css') }}">
    <!-- Notika icon CSS
		============================================ -->
    <link rel="stylesheet" href="{{ asset('css/admin/notika-custom-icon.css') }}">
    <!-- main CSS
		============================================ -->
...
<div class="contact-hd dialog-hd text-center">
    <h2>Панель управления Сонографи</h2>
</div>
...
<!-- knob JS
    ============================================ -->
<script src="{{ asset('js/admin/knob/jquery.knob.js') }}"></script>
<script src="{{ asset('js/admin/knob/jquery.appear.js') }}"></script>
<script src="{{ asset('js/admin/knob/knob-active.js') }}"></script>
<!--  Chat JS
    ============================================ -->
<script src="{{ asset('js/admin/chat/jquery.chat.js') }}"></script>
<!--  wave JS
    ============================================ -->
<script src="{{ asset('js/admin/wave/waves.min.js') }}"></script>
<script src="{{ asset('js/admin/wave/wave-active.js') }}"></script>
<!-- icheck JS
    ============================================ -->
...
<!--  todo JS
    ============================================ -->
<script src="{{ asset('js/admin/todo/jquery.todo.js') }}"></script>
<!-- Login JS
    ============================================ -->
<script src="{{ asset('js/admin/login/login-action.js') }}"></script>
<!-- plugins JS
    ============================================ -->
